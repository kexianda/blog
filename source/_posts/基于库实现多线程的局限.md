...
C++多线程库有很多，如openMP, ACE, boost::thread等。但Boehm指出，C++的多线程库大多数情况是OK的，但在有些情况下是有问题的，列举举了三种情况。此外，因库隐藏了底层现实，在追求极致性能的地方使用库有限制。Boehm的结论是：C++必须在语言层面上支持多线性。正因Boehm和Herb Sutter的努力，C++11支持了多线程。
